...
function ndr_formidable_tcl_options_form($field, $display, $values)
            ...
            <tr>
                <td id="fld_kod" data-label="KOD Giriş Alanı" data-value="<?php echo esc_attr($field['fld_kod']); ?>">
                    ...
                    <?php } else { ?>
                        ...
                        <label for="field_options[fld_kod_<?php echo esc_attr($field['id']) ?>]" class="howto">KOD alanı IDsi
                        </label>
                        <input type="text" name="field_options[fld_kod_<?php echo esc_attr($field['id']) ?>]"
                            value="<?php echo esc_attr($field['fld_kod']); ?>" class="frm_long_input"
                            id="fld_kod_<?php echo esc_attr($field['id']) ?>" />
    ...
    <tr>
        <td>
            ...
            <textarea name="field_options[error_kodkontrol<?php echo $fieldID; ?>]" class="frm_long_input"
                id="error_kodkontrol<?php echo $fieldID; ?>" />
            <?php echo esc_attr($field['error_kodkontrol']); ?></textarea>
        </td>
    </tr>
...
function ndr_formidable_tcl_update_field_options($field_options, $field, $values)
    ...
    $defaults = array(
        'error_kodkontrol' => __('Lütfen Bilgilerinizi kontrol ediniz.', "formidable"),
        'fld_kod'          => null,
    );
